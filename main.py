...
def loadImages():
    ...
    This will be called exactly once in the main as it is a heavy process.
    """
...
def main():
    ...
    player_one = (player_select_one == "1") # if a human is playing white, then this will be True, else False
    player_two = (player_select_two == "1")  # if a human is playing black, then this will be True, else False
